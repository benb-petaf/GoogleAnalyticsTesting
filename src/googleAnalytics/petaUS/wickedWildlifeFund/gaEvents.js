...
if (currentPage.indexOf('testsite.com/enews.aspx') > 0) {
	sendEvent(petaGA_petaGA_FormCategory_eNews, petaGA_FormAction_Initiated, 'Test Site E-News Form');
}
else if (currentPage.indexOf('testsite.com/enewsTY.aspx') > 0) {
	sendEvent(petaGA_petaGA_FormCategory_eNews, petaGA_FormAction_Submitted, 'Test Site E-News Form');
}